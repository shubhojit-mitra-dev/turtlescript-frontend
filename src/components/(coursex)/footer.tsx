    ...
    <footer className="bg-secondary mt-auto">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">About CourseX</h3>
            <p className="text-muted-foreground">
              CourseX is your gateway to knowledge, offering cutting-edge courses and interactive content to help you achieve your learning goals.
            </p>
          </div>
          <div>
